...
const Footer = () => {
  ...
  const socialIcons = [
    { icon: FaTwitter, href: siteData.socialLinks.twitter, label: 'Twitter', color: '#1DA1F2' },
    { icon: FaInstagram, href: siteData.socialLinks.instagram, label: 'Instagram', color: '#E4405F' },
    { icon: FaTelegramPlane, href: siteData.socialLinks.telegram, label: 'Telegram', color: '#26A5E4' },
    { icon: FaWhatsapp, href: siteData.socialLinks.whatsapp, label: 'WhatsApp', color: '#25D366' },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              {socialIcons.map((social) => (
                ...
                >
                  <social.icon 
                    className="w-4 h-4 text-gray-300 hover:text-primary transition-colors" 
                  />
                </a>
              ))}
            </div>
            ...
            <ul className="space-y-2">
              {siteData.navigation.map((link) => (
                <li key={link.path}>
                  <Link
                    to={link.path}
                    className="text-sm text-gray-300 hover:text-primary transition-colors duration-200 inline-flex items-center gap-1 group"
                  >
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-start gap-3">
                <FaWhatsapp className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <a
          ...
          <div>
            ...
            <form onSubmit={handleSubscribe} className="flex flex-col gap-2">
              <div className="flex gap-2">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 bg-primary text-primary-foreground rounded-lg text-sm font-medium hover:bg-primary/90 transition-all hover:scale-105 cursor-pointer"
                >
                  Subscribe
                </button>
              </div>
